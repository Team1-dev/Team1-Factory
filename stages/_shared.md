...
<!-- findings-card -->
Team1's running log of things noticed while working other cards, one comment per finding. Not itself worked — a person reads it and opens a card for anything worth doing.
<!-- no-project-file -->
