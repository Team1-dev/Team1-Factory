...
// headings one level down under a title of its own — the contract's own two headings are enforced by sectionOf, not
// trusted from the model's output.
export const PLAN_CUT = ['Reply', 'Plan'];
export const PLAN_NORMALIZE = ['Reply', 'Plan', 'Implementation'];
